...
module ``Data 2016`` =
    ...
    let private knockoutMatches = [ match37SwitzerlandVsPoland; match38WalesVsY; match39XVsY; match40FranceVsY; match41GermanyVsY; match42XVsY; match43ItalyVsY; match44EnglandVsY
