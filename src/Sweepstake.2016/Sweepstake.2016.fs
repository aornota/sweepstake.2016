...
module ``Sweepstake 2016`` =
    ...
    // Before first draft...
    let private chrisPicks0 = { Participant = chris; CoachTeam = None; Picks = [] }
    let private denisPicks0 = { Participant = denis; CoachTeam = None; Picks = [] }
    let private hughPicks0 = { Participant = hugh; CoachTeam = None; Picks = [] }
    let private jemPicks0 = { Participant = jem; CoachTeam = None; Picks = [] }
    let private joshPicks0 = { Participant = josh; CoachTeam = None; Picks = [] }
    let private nephPicks0 = { Participant = neph; CoachTeam = None; Picks = [] }
    let private robPicks0 = { Participant = rob; CoachTeam = None; Picks = [] }
    let private rosiePicks0 = { Participant = rosie; CoachTeam = None; Picks = [] }
    let private steveMPicks0 = { Participant = steveM; CoachTeam = None; Picks = [] }
    let private steveSPicks0 = { Participant = steveS; CoachTeam = None; Picks = [] }
    let private susiePicks0 = { Participant = susie; CoachTeam = None; Picks = [] }
    let private willPicks0 = { Participant = will; CoachTeam = None; Picks = [] }
    ...
    // Before second draft...
    let private chrisPicks1 = { Participant = chris
    ...
    let private denisPicks1 = { Participant = denis
    ...
    let private hughPicks1 = { Participant = hugh
                               CoachTeam = None
    ...
    let private jemPicks1 = { Participant = jem
    ...
    let private joshPicks1 = { Participant = josh
    ...
    let private nephPicks1 = { Participant = neph
    ...
    let private robPicks1 = { Participant = rob
    ...
    let private rosiePicks1 = { Participant = rosie
    ...
    let private steveMPicks1 = { Participant = steveM
    ...
    let private steveSPicks1 = { Participant = steveS
    ...
    let private susiePicks1 = { Participant = susie
    ...
    let private willPicks1 = { Participant = will
    ...
    // Final teams...
    let private chrisPicksFinal = { Participant = chris
                                    CoachTeam = Some spain
    ...
    let private denisPicksFinal = { Participant = denis
                                    CoachTeam = Some russia
                                    Picks = [ { Player = neuerManuel; OnlyScoresFrom = None } (* goalkeeper *)
                                              { Player = lukakuRomelu; OnlyScoresFrom = None }
                                              { Player = kroosToni; OnlyScoresFrom = None }
    ...
    let private hughPicksFinal = { Participant = hugh
    ...
    let private jemPicksFinal = { Participant = jem
                                  CoachTeam = Some france
    ...
    let private joshPicksFinal = { Participant = josh
                                   CoachTeam = Some austria
                                   Picks = [ { Player = buffonGianluigi; OnlyScoresFrom = None } (* goalkeeper *)
                                             { Player = baleGareth; OnlyScoresFrom = None }
                                             { Player = gotzeMario; OnlyScoresFrom = None }
    ...
    let private nephPicksFinal = { Participant = neph
                                   CoachTeam = Some croatia
                                   Picks = [ { Player = hartJoe; OnlyScoresFrom = None } (* goalkeeper *)
                                             { Player = mullerThomas; OnlyScoresFrom = None }
                                             { Player = nolito; OnlyScoresFrom = None }
    ...
    let private robPicksFinal = { Participant = rob
                                  CoachTeam = Some belgium
                                  Picks = [ { Player = llorisHugo; OnlyScoresFrom = None } (* goalkeeper *)
                                            { Player = martialAnthony; OnlyScoresFrom = None }
                                            { Player = fabregasCesc; OnlyScoresFrom = None }
    ...
    let private rosiePicksFinal = { Participant = rosie
                                    CoachTeam = Some england
    ...
    let private steveMPicksFinal = { Participant = steveM
                                     CoachTeam = Some germany
                                     Picks = [ { Player = courtoisThibaut; OnlyScoresFrom = None } (* goalkeeper *)
                                               { Player = gomezMario; OnlyScoresFrom = None }
                                               { Player = payetDimitri; OnlyScoresFrom = None }
    ...
    let private steveSPicksFinal = { Participant = steveS
                                     CoachTeam = Some portugal
                                     Picks = [ { Player = cechPetr; OnlyScoresFrom = None } (* goalkeeper *)
                                               { Player = giroudOlivier; OnlyScoresFrom = None }
                                               { Player = roseDanny; OnlyScoresFrom = None }
    ...
    let private susiePicksFinal = { Participant = susie
                                    CoachTeam = Some italy
                                    Picks = [ { Player = fabianskiLukasz; OnlyScoresFrom = None } (* goalkeeper *)
                                              ...
                                              { Player = zozulyaRoman; OnlyScoresFrom = None } ] }

    let private willPicksFinal = { Participant = will
                                   CoachTeam = Some poland
                                   Picks = [ { Player = tatarusanuCiprian; OnlyScoresFrom = None } (* goalkeeper *)
                                             { Player = ronaldoCristiano; OnlyScoresFrom = None }
                                             { Player = pogbaPaul; OnlyScoresFrom = None }
    ...
    let private sweepstakersFinal = [ chrisPicksFinal; denisPicksFinal; hughPicksFinal; jemPicksFinal; joshPicksFinal; nephPicksFinal; robPicksFinal; rosiePicksFinal; steveMPicksFinal
                                      steveSPicksFinal; susiePicksFinal; willPicksFinal ]

    let sweepstakers = sweepstakersFinal

    let pickedPlayers = sweepstakers |> List.collect (fun sweepstaker -> sweepstaker.Picks |> List.map (fun pick -> pick, sweepstaker))
